...
<div class="container-fluid py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tambah Institusi</li>
        </ol>
    </nav>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Tambah Institusi Baru</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="/dashboard/institutions/create">
                        <div class="mb-3">
                            <label for="name" class="form-label">Nama Institusi</label>
                            <input type="text" class="form-control" id="name" name="name" 
                                   value="<?= isset($old['name']) ? esc($old['name']) : '' ?>" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="address" name="address" rows="3" 
                                      placeholder="Alamat lengkap institusi..."><?= isset($old['address']) ? esc($old['address']) : '' ?></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="code" class="form-label">Kode Institusi <small class="text-muted">(Opsional)</small></label>
                            <input type="text" class="form-control" id="code" name="code" 
                                   value="<?= isset($old['code']) ? esc($old['code']) : '' ?>" 
                                   placeholder="Contoh: UI, ITB, UGM">
                            <small class="text-muted">Kode singkat untuk institusi, jika ada</small>
                        </div>

                        <div class="d-flex gap-2">
                            <button type="submit" class="btn" style="background-color: #38b6ff; border-color: #38b6ff; color: white;">Tambah Institusi</button>
